    ...
    for query in test_queries:
        ...
        if result['has_product_info']:
            ...
            for product in products:
                print(f"  ✅ 找到: {product['name']} - ${product['price']}/{product['unit']}")
        else:
            print(f"  ❌ 未找到相关产品")
